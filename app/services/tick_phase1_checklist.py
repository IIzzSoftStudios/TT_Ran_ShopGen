...
PHASE1_VALIDATION_CHECKLIST = (
    ...
    "Consistency: SimulationState.current_tick aligned with GMProfile.current_game_day on tick.",
    "Schema: gm_world_state exists; tick_seq / tick_generation_id written when WORLD_STATE_ENABLED.",
    "Safety: WORLD_STATE_ENABLED default False; READ_PRICES_FROM_WORLD_STATE only after blob populated.",
